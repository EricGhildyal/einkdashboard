...
def display_test():
    try:
        ...
        print("/init and clear")
        print("load fonts")
        display_font = ImageFont.truetype('Righteous-Regular.ttf', 50)
        number_font = ImageFont.truetype('BungeeShade-Regular.ttf', 40)
        print("/load fonts")
        ...
        draw.text((15, 0), 'Uptime', font = display_font, fill = 0)
        print("/drawing")
        # print("drawing line1")
        # draw.line((15, 0), fill = 0, width=epd.width)
        # print("/drawing line1")
        print("drawing nums")
        draw.text((100, 0), 'Arrowroot - 98.999%', font = number_font, fill = 0)
        draw.text((150, 0), 'Waterlily - 98.899%', font = number_font, fill = 0)
        print("/drawing nums")
        # print("drawing line2")
        # draw.line((25, 0), fill = 0, width=epd.width)
        # print("/drawing line2")
        print("drawing line3")
        draw.line((0, 300), fill = 5, width = 500)
        print("/drawing line3")
        print("displaying")
